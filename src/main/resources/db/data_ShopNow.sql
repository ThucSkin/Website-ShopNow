USE [WebShop]
GO
/****** Object:  Table [dbo].[Accounts]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Authorities]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Categories]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Comments]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Favorites]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FeedBacks]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderDetails]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Roles]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Statitic]    Script Date: 3/21/2023 7:42:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (4, N'Realme C35', 120, 4990000, 20, N'realme-9-pro.jpg', N'realme1.png', N'realme-2.png', N'realme-3.png', N'1sao.png', CAST(N'2022-11-10' AS Date), N'Chip A13 Bionic, hệ điều hành IOS 13 kết hợp hoàn hảo 
...
Pin chuẩn Li-Ion, dung lượng pin tốt, thời gian lướt web lâu.', 2, N'hot-icon.gif', 6490000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (8, N'Iphone 11 64GB', 100, 10790000, 15, N'ip11.png', N'ip11-1.png', N'ip11-2.png', N'ip11-3.png', N'4sao.png', CAST(N'2022-01-01' AS Date), N'Chip A13 Bionic, hệ điều hành IOS 13 kết hợp hoàn hảo - 
RAM 4GB, bộ nhớ trong 64GB hoạt động mượt mà, đa nhiệm -
Hệ thống camera kép mới 12 MP cho góc chụp siêu rộng -
Camera selfie 12 MP chụp hình ở chế độ chuyển động chậm -
Màn hình IPS LCD 6.1 inch Liquid Retina hiển thị sắc nét -
Pin chuẩn Li-Ion, dung lượng pin tốt, thời gian lướt web lâu.', 2, N'white-img.png', 12000000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (9, N'iPhone 13 Pro Max 256GB Vàng Đồng', 50, 36290000, 25, N'ip13MaVang.png', N'img-1.png', N'img-2.png', N'img-3.png', N'3sao.png', CAST(N'2022-01-01' AS Date), N'Chip Apple A15 Bionic xử lý tác vụ mạnh mẽ, trải nghiệm game mượt mà. -
...
Bộ nhớ trong 64GB đủ đáp ứng nhu cầu lưu trữ dữ liệu. ', 2, N'white-img.png', 21990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (11, N'Laptop HP 14-DV2051TU i3', 20, 16690000, 15, N'Laptop HP 14-DV2051TU i3.png', N'laptopAsus-1.png', N'laptopAsus-3.png', N'laptopAsus-2.png', N'5sao.png', CAST(N'2022-11-10' AS Date), N'Thiết kế sang trọng, tinh tế, hiện đại với trọng lượng nhẹ chỉ 1.41 kg. -
...
Màn hình FHD 14 inch với góc nhìn 178° mang đến khung nhìn tuyệt vời.', 3, N'white-img.png', 17690000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (14, N'Iphone14 Pro Max 512GB', 450, 43590000, 15, N'iphone14_512GB.jpg', N'img-2.png', N'img-1.png', N'img-3.png', N'5sao.png', CAST(N'2020-10-19' AS Date), N'RAM 4GB, bộ nhớ trong 64GB hoạt động mượt mà, đa nhiệm
Hệ thống camera kép mới 12 MP cho góc chụp siêu rộng
Camera selfie 12 MP chụp hình ở chế độ chuyển động chậm
Màn hình IPS LCD 6.1 inch Liquid Retina hiển thị sắc nét', 2, N'white-img.png', 45590000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (17, N'Laptop Acer Aspire 3 A315-59-381E i3', 20, 13490000, 15, N'Laptop Acer Aspire 3.png', N'laptopAsus-1.png', N'laptopAsus-2.png', N'laptopAsus-3.png', N'5sao.png', CAST(N'2022-10-19' AS Date), N'Sở hữu thiết kế nhỏ gọn, kiểu dáng thời thượng với màu bạc cuốn hút. -
...
Đa dạng các cổng kết nối thông dụng đáp ứng tốt nhu cầu làm việc và giải trí.', 3, N'white-img.png', 15490000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (18, N'NULMacbook Air M2 2022L', 50, 17800000, 10, N'Macbook Air M2 2022.png', N'laptopAsus-1.png', N'laptopAsus-2.png', N'laptopAsus-3.png', N'5sao.png', CAST(N'2022-10-20' AS Date), N'
Macbook Air M2 2022 13.6 inch Apple M2 16GB 256GB', 3, N'white-img.png', 19800000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (19, N'Macbook Pro 16', 40, 17490000, 10, N'Macbook Pro 16.png', N'laptopAsus-1.png', N'laptopAsus-2.png', N'laptopAsus-3.png', N'3sao.png', CAST(N'2022-10-20' AS Date), N'Macbook Pro 16 inch 2021 【Apple M1 Pro 10-core CPU, 16-core GPU】16GB 1TB', 3, N'white-img.png', 19490000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (22, N'iPad Pro 11 2020', 150, 15490000, 15, N'iPad Pro 11 2020.png', N'ipad-3.png', N'ipad-2.png', N'ipad-1.png', N'4sao.png', CAST(N'2022-10-28' AS Date), N'Đánh giá iPad Pro 11 2020 Wifi – Tablet với hệ thống camera sau và con chip A12Z ấn tượng', 4, N'white-img.png', 16000000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2015, N'Điện thoại Xiaomi Redmi Note 11 Pro', 10, 6790000, 20, N'Xiaomi-redmi-note-11-blue-600x600.jpg', N'xiaomi-1.png', N'xiaomi-2.png', N'xiaomi-3.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Xiaomi Redmi Note 11 Pro 4G mang trong mình khá nhiều những nâng cấp cực kì sáng giá. Là chiếc điện thoại có màn hình lớn, tần số quét 120 Hz, hiệu năng ổn định cùng một viên pin siêu trâu.
...
Ghi lại những điều thú vị trong cuộc sống của bạn tựa như một bộ phim điện ảnh với nhiều chế độ quay như Audio Zoom, Magic Zoom, Time Freeze,... thao tác điều chỉnh nhanh chóng với một cái chạm.', 2, N'white-img.png', 11990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2019, N'Điện thoại POCO C40', 10, 2990000, 30, N'xiaomi-poco-c40-thumb-vang-600x600.jpg', N'xiaomi-1.png', N'xiaomi-3.png', N'xiaomi-2.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Tháng 06/2022 điện thoại POCO C40 đã chính thức được cho ra mắt tại thị trường Việt Nam, sở hữu màn hình kích thước lớn, viên pin dung lượng khủng và một con chip JR510 mới lạ trên thị trường công nghệ hiện nay.
Pin khỏe, vui lâu
...
Các thông số trên khá cơ bản trong tầm giá, đồng thời do sở hữu một màn hình lớn và chỉ dừng lại ở độ phân giải HD+ nên khi nhìn kỹ thì hình ảnh dừng ở mức tạm ổn, không bị rỗ nhiều, phù hợp cho các nhu cầu cơ bản của hầu hết mọi người dùng hiện nay.', 2, N'white-img.png', 3090000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2020, N'Điện thoại Xiaomi Redmi Note 11 (6GB/128GB)', 15, 4990000, 15, N'Xiaomi-redmi-note-11-blue-600x600.jpg', N'xiaomi-1.png', N'xiaomi-2.png', N'xiaomi-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Redmi Note 11 (6GB/128GB) vừa được Xiaomi cho ra mắt, được xem là chiếc smartphone có giá tầm trung ấn tượng, với 1 cấu hình mạnh, cụm camera xịn sò, pin khỏe, sạc nhanh mà giá lại rất phải chăng.
...
Chụp góc siêu rộng - Xiaomi Redmi Note 10S 6GB.', 2, N'white-img.png', 5990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2024, N'Điện thoại iPhone 11 64GB', 10, 11990000, 15, N'iphone-xi-xanhla-600x600.jpg', N'img-3.png', N'img-2.png', N'img-1.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Apple đã chính thức trình làng bộ 3 siêu phẩm iPhone 11, trong đó phiên bản iPhone 11 64GB có mức giá rẻ nhất nhưng vẫn được nâng cấp mạnh mẽ như iPhone Xr ra mắt trước đó.
...
Màn hình giải trí siêu mượt cùng tần số quét 120 Hz.', 2, N'hot-icon.gif', 28990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2026, N'Điện thoại iPhone 14 Pro Max 128GB', 10, 33990000, 10, N'iphone-14-pro-max-bac-thumb-600x600.jpg', N'img-2.png', N'img-3.png', N'img-1.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Cuối cùng thì chiếc iPhone 14 Pro Max cũng đã chính thức lộ diện tại sự kiện ra mắt thường niên vào ngày 08/09 đến từ nhà Apple, kết thúc bao lời đồn đoán bằng một bộ thông số cực kỳ ấn tượng cùng vẻ ngoài đẹp mắt sang trọng. Từ ngày 14/10/2022 người dùng đã có thể mua sắm các sản phẩm iPhone 14 series với đầy đủ phiên bản tại Thế Giới Di Động.
...
Phiên bản màu tím - iPhone 14 Pro Max.', 2, N'hot-icon.gif', 35590000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2027, N'Điện thoại iPhone 14 Pro 128GB', 10, 29590000, 10, N'iphone-14-pro-bac-thumb-600x600.jpg', N'img-3.png', N'img-1.png', N'img-2.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Tại sự kiện ra mắt sản phẩm thường niên diễn ra vào tháng 9/2022, Apple đã trình làng iPhone 14 Pro với những cải tiến về thiết kế màn hình, hiệu năng, sẵn sàng cùng bạn chinh phục mọi thử thách. Giờ đây người dùng đã có thể mua sắm những sản phẩm iPhone 14 từ ngày 14/10/2022 tại Thế Giới Di Động với đầy đủ các phiên bản.
Thuộc tính	Thông số
...
Một điểm mới trong lần ra mắt này là về phiên bản màu sắc Deep Purple chưa từng có trên các dòng iPhone trước đây. Vì thế đây chắc hẳn sẽ là phiên bản hot nhất trên iPhone 14 Pro nhờ đặc điểm nhận diện cực cao.', 2, N'hot-icon.gif', 3090000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2028, N'Điện thoại iPhone 13 Pro 128GB', 10, 25990000, 15, N'iphone-13-pro-gold-1-600x600.jpg', N'img-1.png', N'img-3.png', N'img-2.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Mỗi lần ra mắt phiên bản mới là mỗi lần iPhone chiếm sóng trên khắp các mặt trận và lần này cái tên khiến vô số người "sục sôi" là iPhone 13 Pro, chiếc điện thoại thông minh vẫn giữ nguyên thiết kế cao cấp, cụm 3 camera được nâng cấp, cấu hình mạnh mẽ cùng thời lượng pin lớn ấn tượng. 
...
Sử dụng tấm nền OLED có số điểm ảnh lên đến 1170 x 2532 Pixels cho hình ảnh và màu sắc hiển thị sâu, sắc sáng tươi tắn, khung hình sinh động như thực.', 2, N'hot-icon.gif', 26990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2029, N'Điện thoại iPhone 12 64GB', 10, 16490000, 20, N'iphone-12-violet-1-600x600.jpg', N'img-3.png', N'img-2.png', N'img-1.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Trong những tháng cuối năm 2020, Apple đã chính thức giới thiệu đến người dùng cũng như iFan thế hệ iPhone 12 series mới với hàng loạt tính năng bứt phá, thiết kế được lột xác hoàn toàn, hiệu năng đầy mạnh mẽ và một trong số đó chính là iPhone 12 64GB.
...
• Máy được trang bị đèn bàn phím chuyển màu RGB độc đáo, tăng độ hăng hái cho game thủ mỗi khi chiến game.', 3, N'white-img.png', 21990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2034, N'Laptop Acer Aspire 7 Gaming A715 42G', 10, 14990000, 20, N'acer-aspire-7-gaming-a715.jpg', N'laptopAsus-2.png', N'laptopAsus-3.png', N'laptopAsus-1.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Laptop Aspire 7 Gaming A715 42G R4XX R5 (NH.QAYSV.008) sở hữu hiệu năng khoẻ cùng thiết kế mạnh mẽ, là bạn đồng hành lý tưởng trong mọi cuộc hành trình.
...
• Chiếc laptop gaming này cho bạn cảm nhận chân thật âm nhạc sống động, ít bị biến dạng nhờ công nghệ âm thanh Acer TrueHarmony.', 3, N'white-img.png', 18890000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2035, N'Laptop Lenovo Legion 5 15IAH7 i5 12500H/8GB', 10, 31690000, 20, N'lenovo-legion-5-15iah7-i5-82rc003wvn-2.jpg', N'laptopAsus-2.png', N'laptopAsus-1.png', N'laptopAsus-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Laptop Lenovo Legion 5 15IAH7 i5 12500H (82RC003WVN) gây ấn tượng bởi lối thiết kế đậm chất thể thao, mạnh mẽ với khả năng vận hành mượt mà mọi tựa game từ nhẹ đến nặng, giúp các cao thủ chiến game đầy tự tin và tận hưởng những giây phút đỉnh cao trong chiến trường ảo.
• Bên trong chiếc laptop gaming này ẩn chứa một con quái vật đến từ bộ vi xử lý Intel Core i5 
', 3, N'white-img.png', 33390000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2036, N'Laptop HP VICTUS 16 d0292TX i5 11400H/8GB/512GB', 10, 26590000, 25, N'hp-victus-16-d0292tx-i5-5z9r3pa-thumb-600x600.jpg', N'laptopAsus-3.png', N'laptopAsus-1.png', N'laptopAsus-2.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Laptop HP VICTUS 16 d0292TX i5 (5Z9R3PA) sẽ là một người bạn đồng hành đắc lực trên mọi chiến trường ảo của game thủ nhờ ngoại hình sang trọng, hiện đại cùng những thông số kỹ thuật mạnh mẽ. 
...
• Laptop HP được trang bị các cổng kết nối bao gồm USB 3.1, Jack tai nghe 3.5 mm, HDMI, LAN (RJ45) và USB Type-C giúp kết nối với các thiết bị ngoại vi khác nhanh chóng hơn.', 3, N'white-img.png', 28890000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2038, N'Laptop Acer Nitro 5 Gaming AN515 45 R6EV R5 5600H', 10, 19490000, 30, N'Laptop Acer Aspire 3.png', N'laptopAsus-1.png', N'laptopAsus-2.png', N'laptopAsus-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Phá cách với diện mạo mạnh mẽ đến từ laptop Acer Nitro 5 Gaming AN515 45 R6EV R5 5600H (NH.QBMSV.006) mang đến cho người dùng hiệu năng ổn định, hỗ trợ bạn trong mọi tác vụ hằng ngày hay chiến những trận game cực căng một cách mượt mà.
...
Đánh bại mọi đối thủ trong mọi trận chiến.', 3, N'white-img.png', 22490000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2040, N'Laptop MSI Gaming GF65 Thin 10UE i5 10500H/16GB', 10, 24290000, 10, N'msi-gamin-gf65-thin-10ue-i5.jpg', N'laptopAsus-1.png', N'laptopAsus-3.png', N'laptopAsus-2.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Tối ưu hóa cho mọi hoạt động từ đồ họa đến chiến game, laptop MSI GF65 Thin 10UE i5 (286VN) sẽ là người cộng sự đắc lực với thiết kế độc đáo và cấu hình mạnh mẽ, cùng bạn xông pha trên mọi chiến trường ảo.
...
• Truyền tải dữ liệu, kết nối nhanh với các thiết bị ngoại vi nhờ các cổng giao tiếp: USB 3.2 Gen 2 Type-C, 2 x USB 3.2, HDMI, LAN (RJ45), Thunderbolt 4.', 3, N'white-img.png', 28990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2042, N'Laptop Lenovo Ideapad Gaming 3 15IAH7 i5', 10, 24190000, 10, N'lenovo-ideapad-gaming-3-15iah7-i5-82s9007tvn.jpg', N'laptopAsus-2.png', N'laptopAsus-1.png', N'laptopAsus-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Laptop Lenovo Ideapad Gaming 3 15IAH7 i5 (82S9007TVN) thuộc dòng laptop gaming mang vẻ đẹp ấn tượng, cuốn hút nhưng không kém phần mạnh mẽ nhờ vào CPU Intel Gen 12, sẵn sàng đồng hành cùng bạn trên mọi đấu trường game hiện nay.
...
Chơi game cực mượt với hiệu năng vượt trội.', 3, N'white-img.png', 26690000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2044, N'Laptop Lenovo Gaming Legion 5 15ACH6 R5', 5, 23790000, 10, N'lenovo-gaming-legion-5-15ach6-r5-82jw00klvn.jpg', N'laptopAsus-2.png', N'laptopAsus-3.png', N'laptopAsus-1.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Với phong cách thiết kế độc đáo cùng card đồ họa NVIDIA GeForce mạnh mẽ, laptop Lenovo Gaming Legion 5 15ACH6 (82JW00KLVN) đáp ứng tốt mọi tác vụ từ học tập, văn phòng nhẹ nhàng đến đồ họa, kỹ thuật chuyên sâu.
...
Hiệu năng tốt, đáp ứng nhu cầu học tập, văn phòng cơ bản.', 3, N'hot-icon.gif', 9880000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2047, N'Máy tính bảng Lenovo Tab M8', 5, 3990000, 10, N'lenovo-tab-m8-tb-8505x400x400-600x600.jpg', N'ipad-1.png', N'ipad-2.png', N'ipad-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Lenovo Tab M8 chiếc máy tính bảng giá rẻ, cấu hình ổn, thiết kế cao cấp trong tầm giá, hoàn toàn phù hợp với các nhu cầu cơ bản như đọc báo, xem phim, lướt web hằng ngày.
...
Với cấu hình này máy chỉ có thể chơi các tựa game nhẹ như: Candy Crush, Plants vs Zombies 2, Minecraft: Pocket Edition,... hay xử lý các tác vụ văn phòng nhẹ.', 4, N'white-img.png', 4090000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2048, N'Máy tính bảng Nokia Tab T20 4G', 10, 4990000, 20, N'nokia-t20-2-600x600.jpg', N'ipad-2.png', N'ipad-3.png', N'ipad-1.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Máy tính bảng Nokia đánh dấu sự trở lại của hãng trên thị trường tablet sau nhiều năm vắng bóng bằng việc ra mắt Nokia Tab T20 máy có thiết kế kim loại sang trọng, hiệu năng ổn định cùng màn hình hiển thị sắc nét, mang đến một lựa chọn không thể bỏ qua trong phân khúc.
Thiết kế bền bỉ
...
Camera trước 5 MP - Nokia Tab T20.', 4, N'white-img.png', 5190000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2049, N'Máy tính bảng Samsung Galaxy Tab S7 FE WiFi', 5, 12990000, 0, N'samsung-galaxy-tab-s7-fe-wifi-600x600.jpg', N'ipad-2.png', N'ipad-1.png', N'ipad-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Samsung Galaxy Tab S7 FE WiFi - được Samsung cho ra mắt với vô vàn tính năng cùng nhiều ưu điểm nổi bật so hơn với các đối thủ trong tầm giá, tablet hỗ trợ bút S Pen nhằm phục vụ các công việc của bạn trở nên dễ dàng hay hiệu suất mạnh mẽ trên một con chip gaming đến từ nhà Qualcomm, khiến nó trở thành một sự lựa chọn không thể bỏ qua đối với người dùng.
Thiết kế sang trọng
...
Samsung Galaxy Tab S7 FE WiFi.', 4, N'white-img.png', 14490000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2050, N'Máy tính bảng Huawei MatePad T10', 5, 4990000, 10, N'huawei-matepad-t10-1-600x600.jpg', N'ipad-3.png', N'ipad-2.png', N'ipad-1.png', N'3sao.png', CAST(N'2022-11-11' AS Date), N'Huawei MatePad T10 là một chiếc máy tính bảng có hiệu năng mạnh mẽ, màn hình lớn, đa năng với các tính năng bảo vệ người dùng, một lựa chọn thú vị với những người muốn tìm kiếm một chiếc máy tính bảng giá mềm dành cho gia đình.
...
Máy tính bảng Huawei MatePad T10 | Thiết kế gọn nhẹ dễ dàng mang đi bất cứ đâu.', 4, N'white-img.png', 5220000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2051, N'Máy tính bảng Samsung Galaxy Tab S8 5G', 2, 20990000, 10, N'samsung-galaxy-tab-s8-white-thumb-600x600.jpg', N'ipad-1.png', N'ipad-3.png', N'ipad-2.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Samsung Galaxy Tab S8 ra mắt và vẫn giữ được đặc trưng của dòng máy tính bảng Galaxy Tab S với cấu hình mạnh mẽ, màn hình hiển thị ổn cùng khả năng hỗ trợ bút S Pen hỗ trợ học tập làm việc tốt hơn.
...
Galaxy Tab A7 Lite | Trang bị màn hình kích thước lớn 8.7 inch.', 4, N'white-img.png', 4190000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2054, N'Máy tính bảng iPad Pro M1 11 inch', 10, 41990000, 40, N'pad-pro-m1-11-inch-wifi-cellular.jpeg', N'ipad-3.png', N'ipad-2.png', N'ipad-1.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Trải nghiệm khung hình sống động cùng cảm giác chạm vuốt cực mượt
...
Thỏa sức sáng tạo cùng cụm camera xịn sò.', 4, N'white-img.png', 42990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2055, N'Máy tính bảng iPad Pro M2 12.9 inch', 10, 35990000, 30, N'ipad-pro-m2-129-wifi-cellular-128gb-231022.jpg', N'ipad-2.png', N'ipad-1.png', N'ipad-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Apple đang ngày càng bỏ xa nhiều đối thủ về mặt hiệu năng trên các dòng tablet, điều này được minh chứng cụ thể bằng sự xuất hiện của con chip Apple M2 siêu mạnh mẽ trên iPad Pro M2 12.9 inch WiFi Cellular 128GB. Bên cạnh đó thì máy còn có những nâng cấp như hệ điều hành iPadOS 16, viên pin 40.88 Wh.
...
Thế hệ chip mới này khi được trang bị trên iPad Pro M2 sẽ có 8 lõi CPU và 10 lõi GPU, điều này giúp tăng cường hiệu suất thêm 15% và 35% về tác vụ xử lý đồ họa khi so với Apple M1.', 4, N'white-img.png', 45590000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2056, N'Máy tính bảng iPad Pro M1 12.9 inch', 5, 29290000, 40, N'ipad-pro-2021-129-inch-gray-600x600.jpg', N'ipad-3.png', N'ipad-1.png', N'ipad-2.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Bạn có đang mong chờ những sản phẩm chất lượng đến từ Apple? Sau hàng loạt các sản phẩm đình đám như iPhone 12 series thì hãng đã tung ra chiếc iPad Pro M1 12.9 inch Wifi Cellular 128GB (2021) trang bị những tính năng ngày càng vượt trội và thời thượng.
...
iPad Pro M1 12.9 inch WiFi Cellular 128GB (2021) | Màn hình trang bị nhiều công nghệ tiên tiến.', 4, N'white-img.png', 33390000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2057, N'Máy tính bảng iPad Air 5 M1 Wifi Cellular 64GB', 20, 20490000, 10, N'ipad-air-5-m1-wifi-cellular-64gb-09032.jpg', N'ipad-1.png', N'ipad-3.png', N'ipad-2.png', N'4sao.png', CAST(N'1900-01-01' AS Date), N'So với chiếc iPad Air 5 M1 Wifi 64GB thì chiếc iPad Air 5 M1 Wifi Cellular 64GB đã có một điểm khác biệt đáng kể đó là phương thức kết nối khi bạn vừa có thể sử dụng Wifi và vừa sử dụng mạng di động một cách bình thường nhưng vẫn cho một trải nghiệm rất tuyệt vời.
...
Có thông số chống nước 5 ATM, yên tâm đeo đồng hồ khi đi mưa, tắm rửa, không đeo đồng hồ khi bơi lội và lặn.', 5, N'white-img.png', 1887000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2059, N'Đồng hồ ADRIATICA 36 mm Nữ A3812.1183QZ', 5, 2320000, 15, N'adriatica-a38121183qz-1-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Thiết kế chiếc đồng hồ kim sang trọng với các chữ số La Mã cổ điển, thích hợp với các cô nàng quý phái, thời thượng
...
Đồng hồ nữ Adriatica A3812.1183QZ có hệ số chống nước 3 ATM.', 5, N'white-img.png', 2520000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2060, N'Đồng hồ MATHEY TISSOT 30 mm Nữ D450BI', 3, 1698000, 35, N'mathey-tissot-d450bi-nu-1-1-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Sang trọng và thanh lịch với sự phối màu hài hòa, thích hợp cho các quý cô nữ tính và quý phái
...
Đồng hồ nữ Mathey Tissot D450BI có hệ số chống nước 5 ATM.', 5, N'white-img.png', 1998000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2061, N'Đồng hồ ADRIATICA 36 mm Nữ A3812.5183Q', 5, 2220000, 10, N'adriatica-a3812-5183q-nu-1-1-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Chiếc đồng hồ này mang màu sắc sang trọng, hiện đại, phù hợp với các quý cô trẻ trung, quý phái
...
Chiếc đồng hồ Adriatica nữ này được tích hợp lịch ngày giúp bạn làm chủ thời gian của mình.', 5, N'white-img.png', 2520000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2062, N'Đồng hồ Q&Q 28.5 mm Nữ S393J212Y', 5, 293000, 20, N'q-q-s393j212y-nu-1-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Là mẫu đồng hồ kim có kiểu dáng hiện đại, tinh tế, dành riêng cho các cô nàng thanh lịch, nữ tính
...
Đồng hồ nữ Q&Q S393J212Y có hệ số chống nước 5 ATM.', 5, N'white-img.png', 313000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2063, N'Đồng hồ CASIO 39.7 mm Nam AE-1200WHD-1AVDF', 5, 1029000, 10, N'casio-ae-1200whd-1avdf-bac-6-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'3sao.png', CAST(N'2022-11-11' AS Date), N'- Thương hiệu đồng hồ Casio của Nhật Bản, uy tín và chất lượng nổi tiếng thế giới
...
- Trang bị đèn nền giúp bạn xem giờ trong bóng tối', 5, N'white-img.png', 1429000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2064, N'Đồng hồ Casio 34 mm Nữ LTP-VT01L-5BUDF', 10, 855000, 10, N'casio-ltp-vt01l-5budf-nu-thumbb-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'• Đây là món phụ kiện thời trang lý tưởng đến từ hãng đồng hồ Casio nổi tiếng của Nhật Bản. Nổi bật với thiết kế đơn giản và tinh tế phù hợp với mọi cô nàng.
...
• Thoải mái khi rửa tay mà không lo hư hỏng vì đồng hồ nữ này có hệ số kháng nước là 1 ATM. Không nên đeo khi đi tắm, đi bơi, lặn.', 5, N'white-img.png', 905000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2065, N'Đồng hồ G-SHOCK 45.4 mm Nam GM-2100-1ADR', 10, 5440000, 15, N'g-shock-gm-2100-1adr-nam-1-1-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'3sao.png', CAST(N'2022-11-11' AS Date), N'• Vừa bóng bẩy, sắc nét lại vừa táo bạo với chiếc đồng hồ G-Shock tiêu chuẩn, của thương hiệu Casio nổi tiếng và uy tín Nhật Bản. Chiếc đồng hồ này thực sự được xem như là một món thời trang thực thụ vì vẻ ngoài được thiết kế cực kì và ấn tượng.
...
• Đồng hồ nam này cũng sở hữu nhiều tiện ích như những chiếc đồng hồ G-Shock khác như: báo thức, bấm giờ thể thao, bấm giờ đếm ngược, giờ thế giới, đồng hồ 24 giờ, sẽ giúp bạn xem giờ tiện lợi hơn.', 5, N'white-img.png', 5540000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2066, N'Đồng hồ Casio 36.3 mm Unisex A168WER-2ADF', 10, 1224000, 20, N'casio-a168wer-2adf-unisex-thumbb-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'• Đồng hồ Casio 36.3 mm Unisex A168WER-2ADF là món phụ kiện thời trang lý tưởng đến từ hãng đồng hồ Casio nổi tiếng của Nhật Bản. 
...
• Báo thức, bấm giờ thể thao, lịch ngày, lịch thứ, đèn nền và đồng hồ 24 giờ là những tiện ích của đồng hồ, giúp người dùng chủ động hơn trong cuộc sống.', 5, N'white-img.png', 1324000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2067, N'Đồng hồ G-SHOCK 40.4 mm Nữ GM-S2100-3ADR', 5, 5111000, 30, N'g-shock-gm-s2100-3adr-nu-thumbb-600x600.jpg', N'dongho-1.png', N'dongho-2.png', N'dongho-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'• Mẫu đồng hồ này phù hợp cho những bạn nữ ưa chuộng sự cá tính và năng động với kiểu dáng thiết kế thể thao, màu sắc trẻ trung. Đồng hồ G-SHOCK 40.4 mm Nữ GM-S2100-3ADR thuộc dòng G-Shock đến từ thương hiệu Casio - Nhật Bản, nổi tiếng với những chiếc đồng hồ chống sốc bền bỉ.
...
• Chiếc đồng hồ G-Shock này được tích hợp nhiều tính năng hỗ trợ bạn trong cuộc sống hàng ngày như: Đèn nền, xem giờ thế giới, báo thức, bấm giờ đếm ngược, bấm giờ thể thao, lịch ngày - thứ - tháng, đồng hồ 24 giờ thuận tiện hơn khi theo dõi thời gian mọi lúc. ', 5, N'white-img.png', 5511000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2069, N'Pin sạc dự phòng Polymer 10.000 mAh Type C', 5, 455000, 20, N'sac-du-phong-10000mah-type.jpeg', N'pin-1.png', N'pin-2.png', N'pin-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Pin sạc dự phòng Polymer 10.000mAh Type C Xmobile PJ JP190ST xanh có kích thước gọn gàng cùng màu sắc đẹp mắt, dễ dàng mang theo đến nhiều nơi và sử dụng khi cần.
...
Sạc lại pin nhanh chóng - Pin sạc dự phòng Polymer 10.000mAh Type C Xmobile PJ JP190ST Xanh..', 8, N'white-img.png', 475000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2070, N'Pin sạc dự phòng Polymer 10.000 mAh QC3', 10, 360000, 25, N'sac-du-phong-polymer-10000mah.jpeg', N'pin-1.png', N'pin-2.png', N'pin-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Pin sạc dự phòng eValu PA F1 Air có vỏ được gia công bằng nhôm rất chắc chắn, không bám vân tay
...
- Cổng sạc Micro USB: 5V - 2A.', 8, N'white-img.png', 380000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2071, N'Pin sạc dự phòng Polymer 20.000 mAh', 5, 1190000, 20, N'polymer-20000mah-type-c-25w-samsung.jpeg', N'pin-1.png', N'pin-2.png', N'pin-3.png', N'3sao.png', CAST(N'2022-11-11' AS Date), N'Kiểu dáng đơn giản, nhỏ gọn, màu đen thời trang
...
Pin sạc dự phòng Polymer 20.000mAh Type C PD 25W Samsung EB-P5300 Đen - 3 cổng kết nối.', 8, N'white-img.png', 1290000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2072, N'Pin sạc dự phòng Polymer 10000mAh AVA', 5, 250000, 20, N'pin-polymer-10000mah-ava.jpeg', N'pin-1.png', N'pin-2.png', N'pin-3.png', N'4sao.png', CAST(N'1900-01-01' AS Date), N'Kích thước nhỏ gọn, màu sắc tinh tế, dễ dùng cho mọi người
...
Có dung lượng 10.000 mAh - Pin sạc dự phòng Polymer 10000mAh Type C Xmobile PW37Y5B Trắng.', 8, N'white-img.png', 450000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2075, N'Chuột Có dây Gaming MSI Clutch GM08 Đen', 10, 420000, 25, N'chuot-co-day-gaming-msi.jpeg', N'chuot-1.png', N'chuot-2.png', N'chuot-3.png', N'4sao.png', CAST(N'1900-01-01' AS Date), N'Chuột có dây Gaming MSI Clutch GM08 Đen được thiết kế đối xứng khiến cho chuột thân thiện với cả người dùng thuận tay trái.
...
• Bên cạnh đó, bạn không cần thông qua ứng dụng mà có thể tùy chỉnh DPI, màu sắc đèn LED, độ sáng trực tiếp qua các nút bấm trên chuột có dây.', 8, N'hot-icon.gif', 600000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2077, N'Bàn phím Có dây Gaming MSI Vigor GK30 US Đen', 10, 970000, 20, N'co-day-gaming-msi-vigor-gk30.jpeg', N'banphim-1.png', N'banphim-2.png', N'banphim-3.png', N'5sao.png', CAST(N'2022-11-11' AS Date), N'Bàn phím Có dây Gaming MSI Vigor GK30 US Đen với chân đế gaming vững vàng ngay bên dưới phím Space Bar đem đến sự vững vàng, chống trượt khi chơi game.
...
Bàn phím Có dây Gaming MSI Vigor GK20 US Đen - Chân đế.', 8, N'hot-icon.gif', 750000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2079, N'Chuột Có dây Gaming Asus Keris', 10, 1060000, 10, N'chuot-co-day-gaming-asus-keris-thumb.jpeg', N'chuot-1.png', N'chuot-2.png', N'chuot-3.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Chuột có dây Gaming Asus Keris có kiểu dáng gọn nhẹ, thiết kế mạnh mẽ, vừa lòng bàn tay khi cầm nắm, tạo cảm giác thoải mái khi chơi game.
...
• Chiếc máy tính để bàn đồ họa này được trang bị nhiều cổng kết nối phổ biến như USB 2.0, Jack 3.5 mm, LAN (RJ45), HDMI và USB 3.2 hỗ trợ tối đa cho quá trình kết xuất và truyền tải dữ liệu đến các thiết bị ngoại vi của người dùng.', 2005, N'white-img.png', 20190000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2081, N'Asus ExpertCenter AIO E5402WHAT i5 11500B', 10, 21490000, 20, N'asus-expertcenter-aio-e5402what-i5.jpg', N'manhinh-1.png', N'manhinh-2.png', N'manhinh-3.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Đến với Asus ExpertCenter AIO E5402WHAT (BA017W), bạn sẽ sở hữu chiếc máy tính nguyên bộ cùng hiệu năng đáp ứng mọi nhu cầu học tập, văn phòng và thiết kế nhỏ gọn tiết kiệm diện tích sử dụng.
...
• Mặt sau máy tính để bàn HP được trang bị đa dạng các cổng kết nối như USB 2.0, Jack 3.5 mm, LAN (RJ45), HDMI và USB 3.2 cho khả năng kết xuất và truyền tải dữ liệu đến các thiết bị ngoại vi nhanh chóng, dễ dàng hơn.', 2005, N'white-img.png', 21590000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2087, N'Lenovo IdeaCentre AIO 3 24ITL6 i5', 20, 19390000, 10, N'lenovo-ideacentre-aio-3-24itl6-i5.jpg', N'manhinh-1.png', N'manhinh-2.png', N'manhinh-3.png', N'4sao.png', CAST(N'2022-11-11' AS Date), N'Nếu bạn đang tìm kiếm một chiếc máy tính nguyên bộ để phục vụ cho công việc, học tập hay giải trí cơ bản thì máy tính Lenovo IdeaCentre AIO 3 24ITL6 i5 (F0G000XBVN) sẽ là người bạn đồng hành đắc lực cho điều đó. 
...
• Máy tính để bàn học tập - văn phòng được trang bị các cổng kết nối như USB 2.0, LAN (RJ45), HDMI và USB 3.2 giúp kết nối với các thiết bị ngoại vi khác dễ dàng hơn.', 2005, N'white-img.png', 19990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2088, N'Mac Mini 2020 M1 8-core/8GB/256GB', 10, 19990000, 10, N'mac-mini-m1-mgnr3saa-thumb-600x600.jpg', N'mac-1.png', N'manhinh-2.png', N'mac-3.png', N'2sao.png', CAST(N'2022-11-11' AS Date), N'Mac mini 2020 M1 (MGNR3SA/A) là dòng Mac nhỏ gọn, linh hoạt và đa năng khi có thể đáp ứng cả các nhu cầu giải trí và làm đồ họa mạnh mẽ với hiệu năng đột phá từ chip M1.
...
• Đảm bảo cho các thiết bị của bạn luôn trong quá trình kết nối tối đa, PC Gaming Asus ROG Strix trang bị hàng loạt các cổng kết nối như Display port, LAN (RJ45), HDMI, USB Type-C, USB 3.2, USB 2.0, Audio jacks, Headphone, Mic in,... với tốc độ truyền tải và kết xuất nhanh chóng.', 2005, N'white-img.png', 44990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2091, N'PC Gaming MSI MAG Infinite S3 12TC i5', 10, 32990000, 25, N'msi-mag-infinite-s3-12tc-i5.jpg', N'asus-rog-strix-g15cf-71270f110w.jpg', N'asus-rog-strix-g15cf-71270f110w.jpg', N'asus-rog-strix-g15cf-71270f110w.jpg', N'4sao.png', CAST(N'2022-11-11' AS Date), N'PC MSI MAG Infinite S3 12TC i5 12400F (251MYS) được thiết kế để mang lại trải nghiệm chiến game tốt nhất cho người dùng, là sản phẩm hoàn hảo dành cho các game thủ chuyên nghiệp cần hiệu năng mạnh mẽ và một thiết kế hầm hố đậm chất gaming.
...
• Đa dạng cổng kết nối như Display port, LAN (RJ45), HDMI, USB 3.2, USB Type-C 3.2 hai chiều để bạn liên kết với mọi thiết bị ngoại vi cùng lúc.', 2005, N'white-img.png', 33990000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2102, N'Tai nghe chụp tai bluetooth P17', 30, 299000, 20, N'Tai-nghe-chup-tai.png', N'tainghe-1.png', N'tainghe-2.png', N'tainghe-3.png', N'5sao.png', CAST(N'2022-11-18' AS Date), N'Tai nghe chụp tai bluetooth P17 Chống Ồn, Micro Gắn Trong, Cổng Jack 3,5mm, Đệm Tai Êm Ái Không Gây Đau Tai. Hàng Chính Hãng.', 8, N'white-img.png', 309000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2116, N'Tai Nghe ATM-40', 35, 3100000, 10, N'Tai-nghe-ATM-40.png', N'tainghe-1.png', N'tainghe-2.png', N'tainghe-3.png', N'4sao.png', CAST(N'2022-11-18' AS Date), N'Với hơn 50 năm phát triển, Audio-Technica đã trở thành thương hiệu tai nghe số 1 Nhật Bản và là 1 trong những thương hiệu uy tín nhất trên thế giới về chất lượng tuyệt vời và thiết kế thời thượng, sắc sảo', 8, N'white-img.png', 3200000)
GO
INSERT [dbo].[Products] ([ProductId], [Name], [Quantity], [UnitPrice], [Discount], [Image1], [Image2], [Image3], [Image4], [Image5], [EnteredDay], [Discription], [CategoryId], [HotSale], [OldPrice]) VALUES (2118, N'IphoneX 64GB', 34, 11399000, 15, N'ipX.jpg', N'ipx1.png', N'ipx2.png', N'ipx3.png', N'5sao.png', CAST(N'2022-11-18' AS Date), N'Màn hình: OLED5.8"Super Retina, Hệ điều hành: iOS 12, Camera sau: 2 camera 12 MP, Camera trước: 7 MP, Chip: Apple A11 Bionic, RAM: 3 GB, Dung lượng lưu trữ: 64 GB, SIM: 1 Nano SIM, Pin Sạc: 2716 mAh.', 2, N'white-img.png', 12299000)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UK23fux5pe6yss1vck8iv9juegn]    Script Date: 3/21/2023 7:42:45 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UKef7fbpy09qu6267gf071q71we]    Script Date: 3/21/2023 7:42:45 PM ******/
